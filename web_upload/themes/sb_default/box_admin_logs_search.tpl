	...
	<table width="80%" cellpadding="0" class="listtable" cellspacing="0">
		...
		<tr>
			<td>
				...
				<tr>
					<td class="listtable_1" width="8%" align="center"><input id="name_" name="search_type" type="radio" value="radiobutton"></td>
				...
				<tr>
					<td class="listtable_1" width="8%" align="center"><input id="ip_" name="search_type" type="radio" value="radiobutton"></td>
					<td class="listtable_1" width="26%">IP address</td>
					<td class="listtable_1" width="66%"><input type="text" id="ip" value="" onmouseup="$('ip_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;"></td>
				</tr>
				<tr>
					<td class="listtable_1"  align="center"><input id="server_" name="search_type" type="radio" value="radiobutton"></td>
					<td class="listtable_1" >Server</td>
					<td class="listtable_1" >
						<select id="server" onmouseup="$('server_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;">
				...
				<tr>
					<td> </td>
					<td> </td>
					<td>{sb_button text="Search" onclick="search_gamelogs();" class="ok" id="searchbtn" submit=false}</td>
				</tr>
				</table>
				</div>
			</td>
